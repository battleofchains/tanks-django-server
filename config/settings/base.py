...
# battle_of_chains/
APPS_DIR = ROOT_DIR / "battle_of_chains"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "battle_of_chains.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "battle_of_chains.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Alexey Mikhailov""", "progressman23@gmail.com")]
